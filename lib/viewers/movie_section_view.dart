  ...
  Widget build(BuildContext context) {
    return Container(
      margin: const EdgeInsets.symmetric(
          horizontal: MARGIN_SMALL, vertical: MARGIN_xXLARGE),
      child: (widget.movieList != null)
          ? GridView.builder(
                        ...
                        child: SizedBox(
                          ...
                          child: Stack(
                            children: [
                              ...
                              Visibility(
                                visible: (widget.dateVisibleIndex == 0)
                                    ? false
                                    : true,
                                child: Align(
                                    ...
                                    child: Container(
                                      ...
                                      child: Padding(
                                        padding: const EdgeInsets.symmetric(
                                            ...
                                            horizontal: MARGIN_SMALL_Lx),
                                        child: Column(
                                          crossAxisAlignment:
                                              CrossAxisAlignment.start,
                                          children: [
                                            Text(
                                              "${DateFormat('d').format(DateTime.parse(widget.movieList?[index].releaseDate ?? ""))} th",
